...
static cpu8080_reg161_t reg_PC;
static cpu8080_reg161_t reg_SP;

static cpu8080_byte_t ram[DATA_MAX_CNT];

static cpu8080_reg162_t _reg_AF;
...
static cpu8080_bool_t halt;

static cpu8080_short_t clock;

static cpu8080_bool_t long_exec;

static cpu8080_byte_t inte;

static cpu8080_byte_t inte_bus;
static cpu8080_bool_t inte_pending;

static cpu8080_byte_t curr_opcode;

static cpu8080_port_in_t port_in;
static cpu8080_port_out_t port_out;
...
static inline cpu8080_short_t cpu8080_POP(void) {
    cpu8080_short_t res = (cpu8080_short_t)ram[reg_SP + 0] | ((cpu8080_short_t)ram[reg_SP + 1] << 8);
    reg_SP += 2;
    return res;
}
...
static inline void cpu8080_XCHG(void) {
